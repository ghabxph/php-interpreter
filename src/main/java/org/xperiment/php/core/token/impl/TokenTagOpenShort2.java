 ...
 */
public class TokenTagOpenShort2 extends TokenTagOpen {
     ...
     * @param tokens      Tokens
     */
    public TokenTagOpenShort2(Line line, Stack<Line> linesToRead, Iterator<Line> iterator, List<Token> tokens) {
