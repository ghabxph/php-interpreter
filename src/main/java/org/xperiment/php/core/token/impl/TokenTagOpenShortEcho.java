 ...
 */
public class TokenTagOpenShortEcho extends TokenTagOpen {
     ...
     * @param tokens      Tokens
     */
    public TokenTagOpenShortEcho(Line line, Stack<Line> linesToRead, Iterator<Line> iterator, List<Token> tokens) {
